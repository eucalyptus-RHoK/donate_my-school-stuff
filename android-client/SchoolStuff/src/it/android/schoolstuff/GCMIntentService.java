...
import it.android.schoolstuff.activities.Login;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onRegistered(Context context, String registrationId) {
		...
		// ServerUtilities
		// .postData(context.getString(R.string.HOST) + "/", params);
		// MainAcitivity.db.insertRecordToCarrello(DBHelper.TABLE_CARRELLO,
		// registrationId, "", "TODO");
	...
	protected void onMessage(Context context, Intent intent) {
		...
		// MainAcitivity.db.insertRecordToNotification(
		// DBHelper.TABLE_NOTIFICATION, message, "TODO", "");
	...
	private static void generateNotification(Context context, String message) {
		...
		String title = "Offerta speciale"; // context.getString(R.string.app_name);
